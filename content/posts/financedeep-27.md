...
- Sell Put 如果截止日的时候价格**高于等于**行权价格，那么买方就不会行权，你就赚到了权利金。
- Sell Put 如果截止日的时候**低于**行权价格，那么买方就会行权，你会使用被冻结的资金以行权价买入指定数量的股票，权利金全部归你。

### Buy Call 没到达行权价格会怎么样？

- Buy Call 如果截止日的时候**高于等于**行权价格，请确保有足够的资金行权，如果资金不够，期权会被强制卖出（平仓）。
- Buy Call 如果截止日的时候**低于**行权价格，期权归零。
