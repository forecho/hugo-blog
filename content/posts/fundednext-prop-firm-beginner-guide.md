...
- **考试规则宽松（无日损、无一致性）**：考试阶段用 `$1,000` 回撤打 `$1,500` 目标。因为**没有日损限制，也没有一致性要求**，它不对你的考试天数做任何限制。如果你抓到一波顺畅的单边行情，靠一两笔大盈亏比（如 1:1.5 或 1:2）的交易，最快 **1 天就能直接通关**，通过后第二天即可升级为出金号。（当然对新手来说一天赚 $1,500 难度极大，普通交易者正常分几天稳扎稳打完成即可，没有日损的束缚会让你操作更自如）。
