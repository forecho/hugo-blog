...
- 删除云端图片
- Pro 开始：API Key 管理，用 `X-API-Key` 调 `/api/v1/api-upload` 批量传图，也可以接 CLI 和 MCP
...
这个项目目前还在持续迭代中，我自己在重度用，意味着遇到问题我会比任何用户都更早发现。如果你也有类似的困扰——想要一个不会突然跑路、支持自己域名、可以接 API / CLI / MCP 的图床，欢迎去 [imgant.com](https://imgant.com) 试试，有问题可以给我发邮件。
