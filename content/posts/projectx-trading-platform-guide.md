...
![](https://img.forecho.com/cFQi3r.png)

我用的是 50k 账户，默认账户给得限制比较大，碰到单边行情，亏损不愿止损，很容易爆仓。所以需要自己改一下限制合约开仓数量，防止单边行情亏损过大。比如我给 MES 设置为 2 手。

当然新手可以先设置为 1 手，不给自己加仓的机会，在不能稳定盈利之前没资格加仓。
